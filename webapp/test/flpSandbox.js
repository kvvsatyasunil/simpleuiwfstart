		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "simple  ui aplication",
									"targetURL": "#comtssimpleui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtssimpleui-display": {
								"semanticObject": "comtssimpleui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ts.simpleui",
									"url": sap.ui.require.toUrl("com/ts/simpleui")
								}
							}
						}
					}
